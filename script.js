...
function openGmail() {
  const email = "hiteshteli386@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Hitesh Parmar Resume.pdf"; // Path to your resume file
  link.download = "Hitesh Parmar Resume"; // Name for the downloaded file
